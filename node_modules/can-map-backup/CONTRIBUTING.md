# Contributing to can-map-backup
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-map-backup) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-map-backup, you can start by going to its [fork page](https://github.com/canjs/can-map-backup/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-map-backup
```
